...
public class MainActivity extends Activity
{
        ...
        public void handleMessage(Message msg)
        {
            ...
            switch (msg.what)
            {
                ...
                case TGDevice.MSG_RAW_DATA:
                    ...
                    break;
                /*
                 * case TGDevice.MSG_HEART_RATE: tv.append("Heart rate: " +
                 * msg.arg1 + "\n"); break;
                 */
                 ...
                 * 
                 * break; case TGDevice.MSG_BLINK: tv.append("Blink: " +
                 * msg.arg1 + "\n"); break; case TGDevice.MSG_RAW_COUNT:
                 * //tv.append("Raw Count: " + msg.arg1 + "\n"); break; case
                 * TGDevice.MSG_LOW_BATTERY:
    ...
    final Handler Newhandler = new Handler()
    {
        public void handleMessage(Message msg)
        {
            ...
            /*
             * case TIME_STAMP: String TimeStamptext =
             * msg.getData().getString("TimeStamp"); tv =
             * (EditText)findViewById(R.id.labelTimeStamp); if (tv !=
             * null)tv.setText(TimeStamptext);
